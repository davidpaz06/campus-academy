...
export default function CreateCourseLessonList({ setCourse, course, moduleIndex }: CourseProps) {
      ...
      <ul>
        {module.lessons.map((lesson, idx) => (
          <div key={idx} className="lesson-card">
            {lesson.type === "Reading" && (
              <ReadingLesson course={course} setCourse={setCourse} moduleIndex={moduleIndex} lessonIndex={idx} />
            )}
            {lesson.type === "Video" && (
              <VideoLesson setCourse={setCourse} course={course} moduleIndex={moduleIndex} lessonIndex={idx} />
            )}
            {lesson.type === "Test" && (
