...
import type { RegisterInstitution } from "@/types";
      ...
      <div className="create-institution-content">
        ...
        <div className="location-section">
          ...
          <div className="location-info">
            ...
            <p>
              We would also like to know a bit about your institution, hence why we invite you to add some social media
              links for a better insight about your needs and goals.
            </p>
