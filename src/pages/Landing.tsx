  ...
  return (
    <div className="flex flex-col items-center justify-center" style={{ height: "100%" }}>
      ...
      <div className="flex gap-4">
        <a href="/login" className="bg-white text-blue-600 px-4 py-2 rounded shadow hover:bg-blue-100">
          Login
        </a>
        <a href="/register" className="bg-white text-blue-600 px-4 py-2 rounded shadow hover:bg-blue-100">
          Register
        </a>
      </div>
    </div>
