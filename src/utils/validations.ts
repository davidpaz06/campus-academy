...
export const validateStudentForm = (data: any) => {
  return validateForm(data, {
    ...
    personSurname: (value) => validators.requiredName(value, "Surname"),
    ...
    personGender: (value) => validators.optional(value, 10),
    institutionId: (value) => validators.uuid(value, "Institution"),
    academicLevelId: (value) => validators.optionalId(value, "Academic level"),
    studyAreaId: (value) => validators.optionalId(value, "Study area"),
